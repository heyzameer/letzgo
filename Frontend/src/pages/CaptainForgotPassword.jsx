...
const CaptainForgotPassword = () => {
  ...
  const handleSendOtp = async (e) => {
    ...
    setMessage('')
    try {
      await axios.post(`${import.meta.env.VITE_BASE_URL}/api/captains/forgot-password`, { email })
  ...
  const handleResetPassword = async (e) => {
    ...
    setMessage('')
    try {
      // Call /api/captains/reset-password with email, otp, and newPassword
      await axios.post(`${import.meta.env.VITE_BASE_URL}/api/captains/reset-password`, {
        email,
        otp,
        newPassword
      })
  ...
  return (
    <div className="max-w-md mx-auto mt-10 p-6 bg-white rounded shadow">
      ...
      <h2 className="text-2xl font-bold mb-6 text-center">Captain Forgot Password</h2>
      {step === 1 && (

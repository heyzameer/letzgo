...
const Riding = () => {
  ...
  let vehicleImg = car;
  if (ride?.captain?.vehicle?.vehicleType === 'auto') vehicleImg = auto;
  if (
    ride?.captain?.vehicle?.vehicleType === 'moto' ||
    ride?.captain?.vehicle?.vehicleType === 'motorcycle' ||
    ...
    <div className='h-screen'>
      ...
      <div className='h-1/2 p-4'>
        <div className='flex items-center justify-between'>
          <img className='h-12' src={vehicleImg} alt={ride?.captain?.vehicle?.vehicleType} />
